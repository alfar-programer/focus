const projects = {
    hero: {
        badge: 'تنفيذ صناعي',
        title: 'مشاريع الطاقة والأتمتة الصناعية',
        subtitle: 'تنفيذ حلول طاقة وأتمتة حرجة في مصر والمملكة العربية السعودية.',
        primaryButton: 'عرض الأعمال',
        secondaryButton: 'تواصل مع الفريق'
    },
    intro: {
        title: 'أداء هندسي على نطاق واسع',
        description: 'تقدم فوكاس للتجارة والمقاولات مشاريع توليد طاقة وأتمتة صناعية ومقاولات كهروميكانيكية بمنهجية معتمدة على المؤشرات في مصر والسعودية.',
