const projects = {
    hero: {
        badge: 'تنفيذ صناعي',
        title: 'مشاريعنا',
        subtitle: 'نقدّم التميز في حلول الطاقة والأتمتة والمقاولات الكهروميكانيكية في مصر والمملكة العربية السعودية.',
        primaryButton: 'عرض الأعمال',
        secondaryButton: 'تواصل مع الفريق'
    },
    intro: {
        title: 'أداء هندسي على نطاق واسع',
        description: 'تمتلك Focus TC سجلاً مثبتاً في تقديم حلول تقنية عالية الأداء للقطاعات الصناعية والتجارية والخدمية، مع التزام بالدقة والسلامة والابتكار.',
