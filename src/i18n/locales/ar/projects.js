const projects = {
    hero: {
        badge: 'تميّز هندسي',
        title: 'مشاريعنا',
        subtitle: 'نقدّم حلولاً متميزة في الطاقة والأتمتة والأعمال الكهروميكانيكية في مصر والمنطقة، من الفكرة حتى التشغيل.',
        primaryButton: 'عرض الأعمال',
        secondaryButton: 'تواصل مع المبيعات'
    },
    intro: {
        title: 'نبني مستقبل الصناعة',
        description: 'من مدينة 6 أكتوبر إلى نطاق الخليج، تمتلك فوكاس سجلًا مثبتًا في تقديم حلول تقنية عالية الأداء للقطاعات الصناعية والتجارية والخدمية، مع التزام بالدقة والسلامة والابتكار.',
        readMethodology: 'اقرأ عن منهجيتنا',
        stats: [
            { icon: 'bolt', value: '500+', label: 'ميجاوات تم تنفيذها' },
            { icon: 'check_circle', value: '120+', label: 'تركيب ناجح' },
            { icon: 'factory', value: '15', label: 'قطاع مخدوم' },
            { icon: 'public', value: '4', label: 'دول نشطة' }
        ]
    },
    grid: {
        categories: {
        ...
        projects: [
            {
                ...
                category: 'industrial',
                description: 'تنفيذ متكامل للأعمال الكهربائية ودمج أنظمة الأتمتة في مشروع توسعة التوربينات مع ضمان جاهزية 99.9%.',
            ...
            },
            {
                ...
                category: 'commercial',
                description: 'تصميم وتنفيذ أنظمة إدارة مبانٍ ذكية وحلول طاقة احتياطية طارئة لفندق فاخر يضم 500 غرفة.',
            ...
            },
            {
                ...
                category: 'industrial',
                description: 'تحديث خطوط تصنيع تقليدية باستخدام حساسات إنترنت الأشياء ولوحات متابعة لحظية للصيانة التنبؤية.',
            ...
            },
            {
                ...
                category: 'commercial',
                description: 'تنفيذ كهروميكانيكي متكامل لبرج تجاري من 45 طابقاً يشمل HVAC ومكافحة الحريق وأنظمة التيار الخفيف.',
            ...
            },
            {
                ...
                category: 'utilities',
                description: 'تطوير نظام سكادا مركزي لمحطة معالجة مياه بلدية لتحسين جرعات المعالجة وتشغيل المضخات.',
    ...
    cta: {
        ...
        description: 'من الاستشارة الأولى حتى التشغيل النهائي، تقدم فوكاس حلولاً كهروميكانيكية متكاملة تناسب متطلباتك.',
        features: [ 'استجابة خلال 24 ساعة', 'استشارة خبراء', 'جودة مضمونة' ],
