const about = {
    section1: {
        ...
        milestones: [
            {
                year: '2005',
                title: 'بداية المنظومة',
                description: 'تأسيس الإطار البنيوي الأول لشركة فوكاس للتجارة والمقاولات ووضع البروتوكولات الميكانيكية الأساسية للتشغيل واسع النطاق.',
                icon: 'foundation',
                protocols: [ 'بروتوكول 01-A', 'بنية أساسية' ],
                reverse: false
            },
            {
                year: '2012',
                title: 'توسع المنظومة',
                description: 'دمج أنظمة MEP المتقدمة عبر المراكز الإقليمية وتوسيع القدرات الفنية وتخصيص الموارد.',
                icon: 'hub',
                protocols: [ 'تكامل MEP', 'شبكة إقليمية' ],
                reverse: true
            },
            {
                year: '2018',
                title: 'ابتكار ذكي',
                description: 'التحول إلى تقنيات المدن الذكية وتطبيق الهندسة المؤتمتة مع نمذجة التوأم الرقمي والمراقبة اللحظية للبنية التحتية.',
                icon: 'smart_assistant',
                protocols: [ 'أتمتة', 'شبكة ذكية' ],
                reverse: false
            },
            {
                year: '2024',
                title: 'المرحلة المستقبلية',
                description: 'المكانة الحالية كشركة تقنية رائدة مع توسع بنية تحتية مستدامة وهندسة شبكة Tier 4 في طليعة الهندسة الميكانيكية.',
                icon: 'rocket_launch',
                protocols: [ 'تصنيف Tier 4', 'هندسة مستدامة' ],
                reverse: true,
                highlight: true
            }
        ],
