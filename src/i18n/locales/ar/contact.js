const contact = {
    ...
    hero: {
        ...
        subtitle: 'دعم حلول توليد الطاقة والأتمتة والمقاولات الكهروميكانيكية في مصر والسعودية.'
    },
    channelsSection: {
        title: 'قنوات<br /><span>التواصل المباشر</span>',
        subtitle: 'تواصل مع فريقنا الهندسي عبر القنوات التالية.',
        channels: [
            {
                icon: '🇸🇦',
                label: 'مكتب السعودية',
            ...
            },
            {
                icon: '🕐',
                label: 'ساعات التشغيل',
                value: 'الاثنين - الجمعة / 08:00-18:00',
    ...
    form: {
        title: 'إرسال استفسار',
        subtitle: 'شارك متطلبات مشروعك وسيتواصل معك فريقنا.',
    ...
    cta: {
        ...
        description: 'خبراؤنا جاهزون لدعم متطلباتك في الطاقة والهندسة الصناعية.',
